 ...
 * @version 1.0
 */
public final class AudioManager extends com.jasonpercus.plugincreator.PluginCreator {
...
//OVERRIDED
    ...
    public String description() {
        return "Allows you to control the windows volume";
    }
    ...
    public String folderName() {
        return "com.jasonpercus.audiomanager";
    }
    ...
    public java.io.InputStream install() {
        return AudioManager.class.getResourceAsStream("resources/"+folderName()+".sdPlugin.zip");
    }
...
//MAIN
    ...
    public static void main(String[] args) {
        ...
        java.io.File cfg = new java.io.File("SoundVolumeView.cfg");
        if(cfg.exists())
            cfg.delete();
    }
